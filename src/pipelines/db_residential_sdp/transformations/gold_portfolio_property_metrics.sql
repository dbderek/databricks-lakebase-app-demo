...
CREATE OR REFRESH MATERIALIZED VIEW startups_catalog.gold.gold_portfolio_property_metrics
...
FROM startups_catalog.silver.silver_properties p
LEFT JOIN (
  SELECT
    property_id,
  ...
  FROM startups_catalog.silver.silver_rents
