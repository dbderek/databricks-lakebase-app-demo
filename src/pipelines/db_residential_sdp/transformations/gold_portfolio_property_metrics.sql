...
CREATE OR REFRESH MATERIALIZED VIEW db_residential_demo.gold.gold_portfolio_property_metrics
...
FROM db_residential_demo.silver.silver_properties p
LEFT JOIN (
  SELECT
    property_id,
  ...
  FROM db_residential_demo.silver.silver_rents
